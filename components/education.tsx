    ...
    >
      ...
      <div className="relative pl-[36px]">
        ...
        {educations.map((edu, i) => (
          <div key={i} className={`relative ${i !== educations.length - 1 ? 'pb-[38px]' : ''}`}>
            <div className={`absolute left-[-36px] top-[5px] w-[11px] h-[11px] rounded-full border-[2px] border-[#8ba6cc] ${edu.status ? 'bg-[#8ba6cc] shadow-[0_0_0_4px_rgba(139,166,204,0.15)]' : 'bg-[#0a0b0d]'}`}></div>
            ...
            <p className="m-0 mb-[14px] text-[15px] leading-[1.65] text-[#8a909c] max-w-[700px]">
              {edu.description}
            </p>
